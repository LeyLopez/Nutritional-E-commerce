"""
Nutritional E-commerce — Asistente IA
...
app = FastAPI(
    title="Asistente IA — Nutritional E-commerce",
    version="1.0.0",
    description=(
        "API que responde preguntas sobre productos de suplementos nutricionales "
...
async def health() -> dict:
    ...
    return {
        "status": "ok",
        "servicio": "Asistente IA — Nutritional E-commerce",
        "version": "1.0.0",
    }
