...
class ContextLoader:
    ...
    Estructura esperada:
        skills/asistente.md   → instrucciones de comportamiento
    ...
    def load_skill(self) -> str:
        ...
        if not path.exists():
            return "Eres un asistente útil de una tienda de suplementos nutricionales."
